...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('send-sms',['as'=>'send-sms','uses'=>'BasicSettingController@sendSMS']);
    ...
    Route::get('chalan/{invoice}',['as'=>'chalan','uses'=>'SellController@chalan']);
    Route::get('print-invoice/{invoice}',['as'=>'print-invoice','uses'=>'SellController@printInvoice']);
    Route::get('print-chalan/{invoice}',['as'=>'print-chalan','uses'=>'SellController@printchalan']);
    ...
    //due report
    Route::get('due-report',['as'=>'due-report','uses'=>'RepaymentController@DueReport']);
...
Route::get('testmessage',function(){
  ...
  $data = [
    "api_key" => "C20006765fd39f6f9284c8.22394152",
    "type" => "{text/unicode}",
    //"contacts" => "8801738298666+88018xxxxxxxx"
    "contacts" => "8801738298666",      
    "senderid" => "Mensa Digi World",
    "msg" => "{test message}",
  ];
  $ch = curl_init();
