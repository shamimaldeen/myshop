        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <li class=" nav-item"><a href="#"><i class="ft-sliders"></i><span data-i18n="" class="menu-title">Instalment Payment</span></a>
                <ul class="menu-content">
                    <li class="{{ Request::is('admin/upcoming-instalment-repayment') ? 'active' : '' }}"><a href="{{ route('upcoming-instalment-repayment') }}" class="menu-item">Upcoming Repayment</a></li>
                    <li class="{{ Request::is('admin/instalment-repayment') ? 'active' : '' }}"><a href="{{ route('instalment-repayment') }}" class="menu-item">New Repayment</a></li>
                    <li class="{{ Request::is('admin/instalment-repayment-history') ? 'active' : '' }}"><a href="{{ route('instalment-repayment-history') }}" class="menu-item">Repayment History</a></li>
                </ul>
            </li>

            <li class=" nav-item"><a href="#"><i class="ft-copy"></i><span data-i18n="" class="menu-title">Due Payment</span></a>
                <ul class="menu-content">
                    <li class="{{ Request::is('admin/upcoming-due-repayment') ? 'active' : '' }}"><a href="{{ route('upcoming-due-repayment') }}" class="menu-item">Upcoming Repayment</a></li>
                    <li class="{{ Request::is('admin/due-repayment') ? 'active' : '' }}"><a href="{{ route('due-repayment') }}" class="menu-item">Due Repayment</a></li>
                    <li class="{{ Request::is('admin/due-repayment-history') ? 'active' : '' }}"><a href="{{ route('due-repayment-history') }}" class="menu-item">Repayment History</a></li>
                    <li> <a href="{{ route('due-report') }}" class="menu-item">Due Report</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href="#"><i class="ft-link-2"></i><span data-i18n="" class="menu-title">Company Payment</span></a>
                <ul class="menu-content">
                    <li class="{{ Request::is('admin/payment-new') ? 'active' : '' }}"><a href="{{ route('payment-new') }}" class="menu-item">New Payment</a></li>
            ...
            <li class="{{ Request::is('admin/manage-instalment') ? 'active' : '' }} nav-item">
                <a href="{!! route('manage-instalment') !!}"><i class="ft-bar-chart-2"></i><span data-i18n="" class="menu-title">Manage Instalment</span></a>
            </li>

            <li class="{{ Request::is('admin/manage-staff') ? 'active' : '' }} nav-item">
                <a href="{{ route('manage-staff') }}"><i class="ft-user-check"></i><span data-i18n="" class="menu-title">Manage Staff</span></a>
            </li>
            ...
            <li class="{{ Request::is('admin/sms-setting') ? 'active' : '' }} nav-item">
                <a href="{!! route('sms-setting') !!}"><i class="fa fa-cog"></i><span data-i18n="" class="menu-title">  Send SMS</span></a>
            </li>
