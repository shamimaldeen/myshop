                ...
                <div class="modal-body">
                    <form id="frmProducts" action="{{ route('submit-due-repayment') }}" method="post" name="frmProducts" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="number" name="repay_due_discount" id="repay_due_discount" class="form-control font-weight-bold" value="" required="" placeholder="Discount Amount"/>
                                    <input type="hidden" name="total_due_after_discount" id="total_due_after_discount"/>
                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).on('click','.open_modal',function(){
            ...
            $.get(url + '/' + order_id, function (data) {
                ...
                //$('#repay_due_discount').val(0);
                $('#total_due_after_discount').val(data.due_amount);
                $('#pay_amount').val('');
        ...
        $('#repay_due_discount').on('input',function (e) {
            var repay_due_discount = e.target.value;
            var total_due = $('#total_due').val();
            $('#due_amount').val(total_due - repay_due_discount);
            var after_discount = $('#due_amount').val();
            $('#total_due_after_discount').val(after_discount);
        });

        $('#pay_amount').on('input',function (e) {
            var due_amount = $('#total_due_after_discount').val();
