...
{{--                                                        <th class="text-right">Due Amount</th>--}}
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $sell->ins_discount }} - {{ $basic->currency }}</td>
                                                             <td class="text-right">{{ $sell->amount - $sell->ins_discount }} - {{ $basic->currency }}</td>
                                                           @else
                                                            <td class="text-right"> 0 - {{ $basic->currency }}</td>
                                                            <td class="text-right">{{ $sell->amount }} - {{ $basic->currency }}</td>
                                                           @endif
...
{{--                                                            @endphp--}}
{{--                                                            <td class="text-right">{{ $due_amount - $sell->pay_amount }} - {{ $basic->currency }}</td>--}}
{{--                                                              @else--}}
...
{{--                                                                        <td class="red text-bold-800 text-right">{{ $due_amount - $sell->pay_amount }} - {{ $basic->currency }}</td>--}}
{{--                                                                    </tr>--}}
{{--                                                                @else--}}
{{--                                                                    <tr class="bg-grey bg-lighten-4">--}}
{{--                                                                        <td class="red text-bold-800">Due Amount</td>--}}
