                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Instalment List</strong></label>
                            <div class="col-md-12">
                ...
                <div class="modal-body">
                    <form id="frmProducts" action="{{ route('submit-instalment-repayment') }}" method="post" name="frmProducts" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="number" name="ins_discount" id="ins_discount" class="form-control font-weight-bold" value="" required="" placeholder="Discount Amount"/>
                                    <input type="hidden" name="total_int_after_discount" id="total_int_after_discount"/>
                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="number" name="pay_amount" id="pay_amount" class="form-control font-weight-bold" value="" required="" placeholder="Pay Amount" />
                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).on('click','.open_modal',function(){
            ...
            $.get(url + '/' + order_id, function (data) {
                ...
                // $('#ins_discount').val(0);
                $('#total_int_after_discount').val(data.amount);
                $('#pay_amount').val('');
        ...
        $('#ins_discount').on('input',function (e) {
            var ins_discount = e.target.value;
            var total_due = $('#total_instalment').val();
            $('#due_amount').val(total_due - ins_discount);
            var after_discount = $('#due_amount').val();
            $('#total_int_after_discount').val(after_discount);
        });

        $('#pay_amount').on('input',function (e) {
            var due_amount = $('#total_int_after_discount').val();
            var pay_amount = e.target.value;
            // var total_due = $('#total_instalment').val();
            $('#due_amount').val(due_amount - pay_amount);
        });
