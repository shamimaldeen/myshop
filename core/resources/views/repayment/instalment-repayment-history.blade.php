                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    <tbody>
                                    @foreach($history1 as $k => $p)
                                        <tr class="{{ $p['deleted_at'] != null ? 'bg-warning white' : '' }}">
                                            <td>{{ ++$k }}</td>
                                            <td>{{ \Carbon\Carbon::parse($p['payment_date'])->format('dS M,y') }}</td>
                                            <td>{{ $p['custom'] }}</td>
                                            <td>{{ $p['ref_custom'] }}</td>
                                            <td>{{ (isset($p['customer']['name'])) ? $p['customer']['name']:''  }} <br> {{ (isset($p['customer']['phone'])) ? $p['customer']['phone']:''  }}</td>
