                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($order as $k => $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if($p->payment_type == 2)
                                                    <a href="{{ url('admin/instalment-repayment-list?custom=').$p->custom }}" class="btn btn-info btn-sm font-weight-bold text-uppercase" title="Instalment List"><i class="fa fa-list"></i> Instalment</a>
                                                @endif
