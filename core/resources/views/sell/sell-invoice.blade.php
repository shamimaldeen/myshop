                                ...
                                <div id="invoice-template" class="card-body">
                                    ...
                                    <div id="invoice-customer-details" class="row pt-2">
                                        ...
                                        <div class="col-md-6 col-sm-12 text-center text-md-right">
                                            <p>
                                                <span class="text-muted"></span> {{ \Carbon\Carbon::parse($sell->created_at)->format('dS M\'y') }}</p>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            @else
                                                                ...
                                                                <tr class="bg-grey bg-lighten-4">
                                                                    <td class="text-bold-800">Total Amount</td>
                                                                    <td class="text-bold-800 text-right">{{ $sell->product_total + $instalment_charge }} - {{ $basic->currency }}</td>
                                                                </tr>
                                                                ...
                                                                <tr class="bg-grey bg-lighten-4">
                                                                    <td class="text-bold-800">Pay Amount</td>
                                                                    <td class="text-bold-800 text-right">{{ $total_pay }}  - {{ $basic->currency }}</td>
                                                                </tr>
