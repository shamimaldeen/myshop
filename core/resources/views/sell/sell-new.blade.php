                            ...
                            <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" >
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;"> Date</strong></label>
                                        <div class="col-md-12">
                                            <div class='input-group'>
                                                <input type='text' name="created_at" class="form-control font-weight-bold" id='datetimepicker2' value="{{ Carbon\Carbon::today() }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select name="customer_id" id="customer_id" class="form-control select24 font-weight-bold">
                                                    <option value="" class="font-weight-bold">Select Customer</option>
                                    ...
                                    <div id="due_paid" style="display: none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input type="number" name="due_pay_amount" id="due_pay_amount" class="form-control bold pay_amount" value="0"   placeholder="Pay Amount" />
                                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class='input-group'>
                                                    <input type='date' name="due_payment_date" class="form-control font-weight-bold" id='datetimepicker2' value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" />
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="instalment_paid" style="display: none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input type="number" name="ins_pay_amount" id="instalment_pay" class="form-control bold pay_amount" value="0"  placeholder="Pay Amount" />
                                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Customer Image</strong></label>
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            <input type="file" name="customer_image" class="form-control bold" value="" placeholder="Customer Image" />
                                                            <span class="input-group-addon"><strong><i class="fa fa-file-text-o"></i></strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Grander one Image</strong></label>
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            <input type="file" name="grander_one_image" class="form-control bold" value="" placeholder="Grander one image"  />
                                                            <span class="input-group-addon"><strong><i class="fa fa-file-text-o"></i></strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                               ...
                                               <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Grander Two Image</strong></label>
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            <input type="file" name="grander_two_image" class="form-control bold" value="" placeholder="Grander Two Image"  />
                                                            <span class="input-group-addon"><strong><i class="fa fa-file-text-o"></i></strong></span>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#instalment_id').on('change',function (e) {
            ...
            var total_amount  = $('#instalment_total').val();
            var paid = $('#instalment_pay').val();
            var due = total_amount - paid;
            $('#instalment_due').val(due);

            if(paid == '')
            {
                    toastr.info('Please fill up pay amount first');
                    $('#instalment_due').val(total);
            }else{
                var url = '{{ url('/') }}';
                $.get(url + '/admin/check-instalment-percent/'+instalment_id+'/'+due,function (data) {
                    var result = $.parseJSON(data);
                    ...
                    if (result['errorStatus'] == "yes"){
                        ...
                        toastr.info(result['errorDetails']);
                        $('#instalment_total').val(total);
                        var pay = $('#instalment_pay').val();

                        $('#instalment_due').val(result.total);
