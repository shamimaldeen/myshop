...
class RepaymentController extends Controller
{
    ...
    public function submitDueRepayment(Request $request)
    {
        ...
        $msg ="প্রিয় গ্রাহক,".$data['customer_name']." মেমো নং ".$data['custom']."
বকেয়া ".$data['total']." টাকা,  ডিসকাউন্ট ".$data['repay_due_discount']." টাকা, বিল নং ".$data['bill_custom']." পরিশোধ ".$data['paid']." টাকা, বাকি " .$data['due']." টাকা
যোগাযোগ: 01967676551
...
//            $nextInstalment->save();
        ...
        $client_msg = "প্রিয় গ্রাহক, ".$data['customer_name']." বিল নং- ".$data['sl_custom']." সর্বমোট বিল ".$data['total']." টাকা, পেমেন্ট নং ".$data['custom']." পরিশোধ ".$data['paid']." টাকা, ডিসকাউন্ট ".$data['total_discount']." টাকা, সর্বমোট পরিশোধ ".$data['totalpaid']." টাকা, সর্বমোট বাকি " .$data['due']." টাকা,
যোগাযোগ: 01967676551
আমাদের শোরুমটি পরিদর্শন করার জন্য ধন্যবাদ";
        $grander_one_msg = "প্রিয় গ্র্যান্ডার, ".$data['grander_one_name']." বিল নং- ".$data['sl_custom']." সর্বমোট বিল ".$data['total']." টাকা, পেমেন্ট নং ".$data['custom']." পরিশোধ ".$data['paid']." টাকা, ডিসকাউন্ট ".$data['total_discount']." টাকা, সর্বমোট পরিশোধ ".$data['totalpaid']." টাকা, সর্বমোট বাকি " .$data['due']." টাকা,
যোগাযোগ: 01967676551
আমাদের শোরুমটি পরিদর্শন করার জন্য ধন্যবাদ";

        $grander_two_msg = "প্রিয় গ্র্যান্ডার, ".$data['grander_two_name']." বিল নং- ".$data['sl_custom']." সর্বমোট বিল ".$data['total']." টাকা, পেমেন্ট নং ".$data['custom']." পরিশোধ ".$data['paid']." টাকা, ডিসকাউন্ট ".$data['total_discount']." টাকা, সর্বমোট পরিশোধ ".$data['totalpaid']." টাকা, সর্বমোট বাকি " .$data['due']." টাকা,
যোগাযোগ: 01967676551
আমাদের শোরুমটি পরিদর্শন করার জন্য ধন্যবাদ";
