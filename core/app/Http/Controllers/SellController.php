...
//                                    $tt1 = Carbon::parse($tt)->addDays($instalment->difference);
       ...
       //$smsdata = ['total'=>$order->total_amount + $instalment_charge,'product_price'=>$request->product_price,'discount'=>$discount,'customer_name'=>$customer->name,'customer_phone'=>$customer->phone,'grand_1'=>$request->grander_one_phone,'grand_2'=>$request->grander_two_phone,'grand_one_name'=>$request->grander_one_name,'grand_two_name'=>$request->grander_two_name,'pay_amount'=> $order->pay_amount,'due'=>$order->due_amount,'invoice'=>$custom];
        ...
        $msg ="প্রিয় গ্রাহক," .$data['customer_name'].",  বিল নং ".$data['invoice']." পণ্যের মুল্য ".$data['product_price']." টাকা, ডিসকাউন্ট ".$data['discount']." টাকা, সর্বমোট বিল ".$data['total']." টাকা, পরিশোধিত বিল ".$data['pay_amount']." টাকা, সর্বমোট  বাকি " .$data['due']." টাকা
যোগাযোগ: 01967676551
New Aman Electronics, ধন্যবাদ ।";
       // dd($msg);
       $grander_one_msg = "প্রিয় গ্র্যান্ডার,".$data['grand_one_name'].", বিল নং ".$data['invoice']." পণ্যের মুল্য ".$data['product_price']." টাকা, ডিসকাউন্ট ".$data['discount']." টাকা, সর্বমোট বিল ".$data['total']." টাকা, পরিশোধিত বিল ".$data['pay_amount']." টাকা, সর্বমোট বাকি " .$data['due']." টাকা,জামানতকারী হিসেবে সম্মতি প্রদান করেছেন।
যোগাযোগ: 01967676551
New Aman Electronics, ধন্যবাদ ।";

        $grander_two_msg ="প্রিয় গ্র্যান্ডার,".$data['grand_two_name'].", বিল নং ".$data['invoice']." পণ্যের মুল্য ".$data['product_price']." টাকা, ডিসকাউন্ট ".$data['discount']." টাকা, সর্বমোট বিল ".$data['total']." টাকা, পরিশোধিত বিল ".$data['pay_amount']." টাকা, সর্বমোট বাকি " .$data['due']." টাকা,জামানতকারী হিসেবে সম্মতি প্রদান করেছেন।
যোগাযোগ: 01967676551
New Aman Electronics, ধন্যবাদ ।";
